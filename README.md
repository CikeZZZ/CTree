...
## 🌳 Output Example / 输出示例
The directory tree generated by CTree uses the **standard tree indentation symbols** (`├──`, `└──`, `│`), clearly showing the nesting hierarchy, and **perfectly supports Unicode paths and file names**:  
